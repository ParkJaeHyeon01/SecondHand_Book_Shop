...
export default function KindFindID  ({navigation}){
  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={{flex:1, backgroundColor:'white', alignItems: 'center'}}>
        <Text style={{fontSize:30, fontWeight:'bold', textAlign:'center', paddingTop:80}}>아이디 찾기</Text>
    ...
    <Next onPress={goToFindID}><Text style={{color:'white', fontSize:20, fontWeight:'bold'}}>확인</Text></Next>
    </SafeAreaView>
    </SafeAreaProvider>
