...
export default function SignupScreen  ({navigation}){
  ...
  const goToSignup1 = () => {
    if (selectedIndex == 1){
    navigation.navigate("SignupCommon", {
...
const getSelectedText = () => {
  return selectedIndex === 1 ? '중고 도서 거래를 이용하고 싶은 개인을 위한 유형입니다.' : '중고 도서 매장을 운영하는 사업자를 위한 유형입니다.';
};

  return (
    <SafeAreaProvider>
      <SafeAreaView style={{flex:1, backgroundColor:'white', alignItems: 'center'}}>
        <Text style={{fontSize:30, fontWeight:'bold', textAlign:'center', paddingTop:80}}>회원가입</Text>
    ...
    <Next onPress={goToSignup1}><Text style={{color:'white', fontSize:20, fontWeight:'bold'}}>확인</Text></Next>
    </SafeAreaView>
    </SafeAreaProvider>
