...
const StoreBookRegister1 = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={{ flex: 1, backgroundColor: 'white', alignItems: 'center' }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginLeft: -100 }}>
        ...
        <ScrollView style={{ width: '90%' }} showsVerticalScrollIndicator={false}>
          ...
          <View style={{ borderWidth: 1, width: '90%', height: 50, borderRadius: 10, justifyContent: 'center', left:20 }}>
            <TextInput style={{ paddingLeft: 20, fontSize: 20 }} placeholder='ISBN' onChangeText={setISBN}></TextInput>
          </View>
...
export default StoreBookRegister1;
